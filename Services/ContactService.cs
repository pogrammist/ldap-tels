...
public class ContactService
{
    ...
    public async Task<IEnumerable<Contact>> GetAllContactsAsync(int page = 1, int pageSize = 50)
    {
        return await _context.Contacts
            ...
            .Where(c => c.ContactType == ContactType.Manual || (c.ContactType == ContactType.Ldap && c.LdapSource.IsActive))
    ...
    public async Task<Contact?> GetContactByIdAsync(int id)
    {
        return await _context.Contacts
            .Include(c => c.LdapSource)
            .FirstOrDefaultAsync(c => c.Id == id && (c.ContactType == ContactType.Manual || (c.ContactType == ContactType.Ldap && c.LdapSource.IsActive)));
    }
